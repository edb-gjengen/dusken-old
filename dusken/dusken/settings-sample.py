...
DATABASES = {
    'default': {
        ...
        'USER': 'mdb_su',                      # Not used with sqlite3.
        'PASSWORD': '',                  # Not used with sqlite3.
        'HOST': 'postgresql.neuf.no',                      # Set to empty string for localhost. Not used with sqlite3.
...
SECRET_KEY = 'pdbd(fky_-95*l#e@h7r#m84ku@m@u!y3@%tuy^%bg_&amp;$d#6ys'
